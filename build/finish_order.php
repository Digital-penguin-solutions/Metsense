...
?> <section id="finish_order" class=""> <?php
    if(isset($_GET['thanks'])){
        ...
        ?> <h1 class="checkout_header">Finish order</h1><form class="col-md-4 col-md-offset-2 customer_info" action="function/email_function.php" method="post"><h1>Customer Information</h1><h2>Email</h2><input id="email" name="email" title="email" placeholder="Email" type="text"><h2>Company name</h2><input id="cname" name="cname" title="cname" placeholder="Company name" type="text"><h2>First name</h2><input id="fname" name="fname" title="fname" placeholder="First name" type="text"><h2>Last name</h2><input id="lname" name="lname" title="lname" placeholder="Last name" type="text"><h2>Country</h2><select id="country" name="country" title="country" name="country"> <?php include "function/select_country.php"; ?> </select><h2>Additional Information (optional)</h2><textarea id="info" name="info" title="info" placeholder="Additional information"></textarea><br><br><p class="">Some additional cost may be added for shipping depending on your location, you will be notified about this as soon as we get back to you</p></form><div class="col-md-3 col-md-offset-1 cart_info"><h1>Order Summary</h1> <?php
            $total_price = 0;
