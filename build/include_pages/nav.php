...
?> <div class="nav_menu_container"><ul class="nav_menu center_css"><li><a class="nav_link" data-scroll href="index#welcome_page"><p>Home</p></a></li><li><a class="nav_link" data-scroll href="index#products_page"><p>Products</p></a></li><li><a class="nav_link" data-scroll href="index#about_us_pages"><p>About us</p></a></li><li><a class="nav_link" href="order"><p>Shopping cart</p></a></li></ul></div><nav class="navbar navbar-default navbar-fixed-top nav-manstyle"><div class="container-fluid full_height"><div class="navbar-header center_css"><a class="navbar-brand" href="index"><img class="nav_logo" alt="Brand" src="img/logo/logo.svg"></a></div></div></nav> <?php
if(!$hide_cart){
