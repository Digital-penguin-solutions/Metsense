...
?> <!DOCTYPE html><html lang="en"><head><meta name="description" content="MetSense - Complete sensor solutions for winter maintenance."><title>MetSense - Home</title><script>smoothScroll.init();</script><script>$(document).ready(function(e) {
            $(window).stellar();
        });</script></head> <?php
//functions
...
?> <!--products wall updated from the database--><div id="wall_1" class="image" data-stellar-background-ratio="0.2"><section id="products_page"><div class="container-fluid full_height"><div class="row full_height"> <?php
                    ...
                    foreach ($products as $product) {
                        ...
                        ?> <div class="col-lg-6 col-sm-12 full_height fade-in"><div class="prud"><figure class="effect-sarah"><!--Link to product--><figcaption class="col-lg-12"><!--Product name--><h2><span><?php echo $name;
                                                echo "$show"; ?></span></h2><!--product description--><p class="description"> <?php echo $short ?> </p></figcaption><!--Picture of product hav to hav a transparent background--> <img class="center_horizontally_css" src="data:image/jpeg;base64,<?php echo base64_encode($main_image_data); ?>" alt="Metsens Prduucts"> <?php
