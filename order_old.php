...
<html>
    ...
    <html>
        ...
        <body id="page-top background_fixed" data-spy="scroll" data-target=".navbar-fixed-top ">
            ...
            <section class = "order_first no_padding">
                <div class = "container-fluid full_height">
                    <div class = "row full_height">
                        <h1 class = "order_header col-lg-4 col-lg-offset-1"> Place an order </h1>
                        <div class = "col-md-12 full_height">
                            <div class = "center_css">

                                <table class = "order_table center_horizontally_css col-lg-12">
                                    <img src = "img/pruduct_temp_img/MetRoad2.jpg" class = "img_order center_css">
                                    <tr>
                                        <td> Price </td>
                                        <td> Quantity </td>
                                        <td> Total </td>
                                ...
                                <table>
									<tr>
										<td class = "order_price"> 1000$ </td>
										<td><div class = "quantity_select">
											<div class = "minus">
												-
											</div>
                                ...
                                <section class="col-lg-4 col-lg-offset-8">
                                    <button id="js-trigger-overlay" type="button">Buy now</button>
                                </section>
                            </div>
                        </div>
                    </div>
