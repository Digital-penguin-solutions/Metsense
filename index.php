...
<html lang="en">
    ...
    <body id="page-top background_fixed" data-spy="scroll" data-target=".navbar-fixed-top ">
        ...
        <!--Aboute metsens-->
        <section id="about_us_pages" class="about_us_page">
            <div class="container-fluid full_height">
                <div class="row full_height">
                    <div class="col-md-6 hidden-sm hidden-xs  about_us full_height">
                        <div class = "row full_height slide-in"> <img class="col-md-12 full_height" src="img/abote.jpg" alt="About-us"> </div>
                    </div>
                    <div class="col-md-6 col-xs-12 about_us center_vertically_css">
                        <div class = "row no_margin fade-in">
                            <h1 class=""> About us </h1>
                            <div class="col-lg-10  col-sm-10 col-sm-offset-1 about_us_p fade-in">
                                <p> MetSense brings innovative sensor solutions to the market for winter road maintenance. This enables mobile and stationary monitoring of parameters such as: Road surface status, Road surface friction, Road surface temperature and more. </p>
